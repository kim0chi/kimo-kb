...
// A notebook's home: its reading path (chapters) + notes/decisions sections.
...
<template>
  <div v-if="data?.notebook">
    ...
    <p v-if="data.chapters.length" class="lede">
      One reading path through everything, in chapters. Read one at a time, in order.
    </p>

    <div v-if="overall.total" class="overall">
      <div class="bar" role="progressbar" :aria-valuenow="pct" aria-valuemin="0" aria-valuemax="100" aria-label="Overall reading progress">
